...
#The retuned Random Forest model shows the best performance between the training set and the test set, and on average predicts the sale price of house to within plus or minus 15% 
